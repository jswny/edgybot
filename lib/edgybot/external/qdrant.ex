defmodule Edgybot.External.Qdrant do
  ...
  def embed_and_find_closest(collection, query, limit, score_threshold \\ 0.0)
      when is_binary(collection) and is_binary(query) and is_integer(limit) and
             is_float(score_threshold) do
